...
[![NPM Package](https://nodei.co/npm-dl/@marsraptor/bitset.png?months=6&height=1)](https://npmjs.org/package/@marsraptor/bitset)

[![Build Status](https://travis-ci.org/MarsRaptor/Bitset.svg)](https://travis-ci.org/MarsRaptor/BitSet)
...
BitSet is an infinite [Bit-Array](http://en.wikipedia.org/wiki/Bit_array) (aka bit vector, bit string, bit set) implementation in JavaScript. That means that if you invert a bit vector, the leading ones get remembered. 
...
===
BitSet.js : Copyright (c) 2014-2018, [Robert Eisele](https://www.xarg.org/)